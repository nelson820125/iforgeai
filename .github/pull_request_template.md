...
<!-- List the key files modified. According to CONTRIBUTING.md, role changes must span all three locations: -->
<!-- - copilot/skills/{role}/SKILL.md -->
<!-- - copilot/agents/{role}.agent.md -->
<!-- - shared/roles/{role}.md -->
<!-- zh-CN counterparts must be updated in the same PR -->
...
- [ ] Commit message uses imperative form (e.g. "Fix architect output missing alternative solutions")
