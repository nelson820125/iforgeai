...
description: "Python Backend Engineer role. Use when you need to implement Python/FastAPI backend features, async REST APIs, data processing pipelines, AI/ML inference services, or web scraping workflows. Keywords: Python, FastAPI, Pydantic, SQLAlchemy, asyncpg, Pandas, Polars, Celery, LangChain, Playwright, Scrapy, backend development, data pipeline."
...
handoffs:
  - label: "✅ Backend development complete, submit for review"
    agent: "digital-team"
    prompt: "Python Engineer has completed this phase of development. Work logs recorded to .ai/records/python-engineer/. Please proceed with Gate 6 approval."
    send: true
  - label: "✅ API contract complete, submit for review"
    agent: "digital-team"
    prompt: "Python Engineer has completed API contract definition. Deliverable: .ai/temp/api-contract.md. Please proceed with Gate 5a approval."
    send: true
